...
notesDisplay.addEventListener("click", (event)=>{
    ...
    switch(dataType)
    {
        ...
        console.log("del clicked")
            ...
            showOtherNotes.innerHTML = renderNotes(arrayOfNotes.filter(({isArchived,isPinned}
            )=> !isArchived && !isPinned));
            ...
            case "archived" :
                arrayOfNotes = arrayOfNotes.map(note=> noteId === note.id.toString() ? {...note, isArchived:!note.isArchived} : note);
